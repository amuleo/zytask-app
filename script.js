...
const levelPointsThresholds = [
    ...
    { level: 10, name: 'خفن', points: 1600, icon: 'fa-solid fa-fire-alt', motivational: 'شما به خفن ترین نسخه از خودتان تبدیل شده‌اید. انرژی و خلاقیت شما بی‌حد و مرز است و هر کاری را به بهترین شکل ممکن انجام می‌دهید!' },
...
const achievementsData = [
    ...
    { level: 10, name: 'خفن', points: 1600, icon: 'fa-solid fa-fire-alt', type: 'level', description: 'شما به خفن ترین نسخه از خودتان تبدیل شده‌اید. انرژی و خلاقیت شما بی‌حد و مرز است و هر کاری را به بهترین شکل ممکن انجام می‌دهید!' },
...
function toggleTaskCompletion(taskId, taskItemElement) {
    ...
    if (taskIndex > -1) {
        ...
        // یادداشت‌ها از طریق کلیک کردن تکمیل نمی‌شوند، فقط از طریق منو خط می‌خورند.
...
helpMenuItem.addEventListener('click', (e) => {
    ...
    helpModalBody.innerHTML = `
        ...
        <p class="semi-formal-text">
            ...
            برای علامت زدن یک وظیفه به عنوان "تکمیل شده" (به جز یادداشت‌ها)، کافیست روی آن کلیک کنید. با این کار، وظیفه به بخش "وظایف تکمیل شده" منتقل می‌شود و پوینت‌های مربوطه به حساب شما اضافه می‌گردد.
        </p>
        <p class="semi-formal-text">
        ...
        <h3 class="text-xl sm:text-2xl font-bold mb-2 mt-4 help-heading-blue">سیستم گیمیفیکیشن</h3> <p class="semi-formal-text">
            ...
            <ul class="list-disc list-inside mt-2 mb-2 text-justify">
                ...
                <li class="semi-formal-text"><strong class="text-orange-600 dark:text-orange-300">یادداشت:</strong> این نوع وظایف برای ثبت نکات، ایده‌ها یا اطلاعاتی هستند که نیازی به تکمیل شدن ندارند و پوینت گیمیفیکیشن نمی‌دهند. حداکثر طول متن برای یادداشت‌ها 55 کاراکتر است.</li>
            </ul>
        </p>
        <p class="semi-formal-text">
            <strong class="text-gray-600 dark:text-gray-300">سطوح:</strong> با کسب پوینت، به سطوح بالاتر صعود خواهید کرد. هر سطح جدید، یک نام و آیکون منحصر به فرد دارد. در زیر لیست تمامی سطوح را مشاهده می‌کنید:
        </p>
        <div id="helpLevelsContainer" class="flex flex-wrap gap-2 mt-1 mb-4">
            </div>
        <p class="semi-formal-text">
            <strong class="text-gray-600 dark:text-gray-300">دستاوردها:</strong> زای تسک دارای مجموعه‌ای از دستاوردها است که با رسیدن به نقاط عطف خاصی (مانند تکمیل تعداد مشخصی وظیفه، رسیدن به سطح خاص و...) باز می‌شوند. می‌توانید تمام دستاوردهای خود را از طریق منوی اصلی (آیکون سه نقطه در بالا سمت چپ) و انتخاب "دستاوردها" مشاهده کنید. دستاوردهای بازنشده به صورت قفل نمایش داده می‌شوند. در زیر لیست تمامی دستاوردها را مشاهده می‌کنید:
        </p>
        ...
        <p class="semi-formal-text">
            ...
            برای ایجاد یک نسخه پشتیبان از داده‌های خود، از منوی اصلی، گزینه "پشتیبان‌گیری" را انتخاب کرده و سپس روی دکمه "ذخیره داده‌ها" کلیک کنید. یک فایل متنی حاوی تمام وظایف، پوینت‌ها، سطح و دستاوردهای شما دانلود خواهد شد. این فایل را در مکانی امن نگهداری کنید.
        </p>
        <p class="semi-formal-text">
            <strong class="text-gray-600 dark:text-gray-300">بازیابی (ورودی گرفتن):</strong>
            برای بازیابی داده‌ها از یک فایل پشتیبان، در همان بخش "پشتیبان‌گیری"، روی "انتخاب فایل" کلیک کرده و فایل متنی پشتیبان خود را انتخاب کنید. سپس "بارگذاری از فایل" را فشار دهید. این کار داده‌های فعلی برنامه شما را با داده‌های موجود در فایل جایگزین می‌کند.
        </p>

        <h3 class="text-xl sm:text-2xl font-bold mb-2 mt-4 help-heading-blue">بروزرسانی برنامه</h3>
        <p class="semi-formal-text">
            این برنامه از <strong class="text-gray-600 dark:text-gray-300">سرویس پس‌زمینه </strong> برای ارائه تجربه آفلاین و بارگذاری سریع استفاده می‌کند. برای اطمینان از اینکه همیشه آخرین نسخه برنامه را دارید و از جدیدترین ویژگی‌ها بهره‌مند می‌شوید، می‌توانید روی گزینه "بروزرسانی برنامه" در منوی اصلی کلیک کنید. این کار کش برنامه را پاک کرده و آخرین نسخه را از سرور بارگذاری می‌کند.
        </p>
		
		<h3 class="text-xl sm:text-2xl font-bold mb-2 mt-4 help-heading-blue">استفاده آفلاین از برنامه</h3>
        <p class="semi-formal-text">
            برای استفاده آفلاین از این برنامه ابتدا اجازه دهید تا صفحه اصلی برنامه به خوبی بارگزاری شود، سپس بعد از بارگزاری کامل برنامه کمی صبر کنید، مدتی بعد بدون قطع کردن اینترنت از برنامه خارج شوید، اینترنت خود را خاموش کرده و به برنامه وارد شوید.
        </p>

        <p class="semi-formal-text text-center text-justify help-heading-blue">
...
importDataBtn.addEventListener('click', () => {
    ...
    reader.onload = (e) => {
        try {
            ...
            showMessageBox('خطا در پردازش فایل وارد شده. اطمینان حاصل کنید که یک فایل جیسون معتبر است.', 'error');
        }
    };
    reader.onerror = (e) => {
    ...
    shareAppLink.addEventListener('click', async (e) => {
        ...
        try {
            await navigator.share({
                title: 'زای تسک',
                text: 'برنامه مدیریت وظایف گیمیفای شده را امتحان کنید!',
